<div>
    ...
    <div class="mb-6">
        ...
        <h3 class="text-lg font-semibold text-gray-900 text-center mb-2">Are you sure you want to delete this program?</h3>
        <p class="text-sm text-gray-600 text-center">
            "<span class="font-semibold text-gray-900">{{ $program->name }}</span>" program to delete?
        </p>
