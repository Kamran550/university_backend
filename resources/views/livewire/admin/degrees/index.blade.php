<div class="p-6 max-w-7xl mx-auto" x-data="{ showModal: false, showEditModal: false, showDeleteModal: false }" @close-modal.window="showModal = false" @close-edit-modal.window="showEditModal = false" @close-delete-modal.window="showDeleteModal = false" @degree-created.window="showModal = false; $wire.$refresh()" @degree-updated.window="showEditModal = false; $wire.$refresh()" @degree-deleted.window="showDeleteModal = false; $wire.$refresh()">
