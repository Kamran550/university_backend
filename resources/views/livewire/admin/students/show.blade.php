    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-6 sm:mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="text-base sm:text-lg text-gray-600">{{ $student->name }} {{ $student->surname }} about more information</p>
                </div>
                ...
                @if($application)
                    <div class="flex items-center gap-3">
                        <button 
                            ...
                            title="Send Diploma">
                            <svg wire:loading.remove wire:target="sendDiploma" class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"/>
                            </svg>
                            <svg wire:loading wire:target="sendDiploma" class="animate-spin w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6 sm:p-8 mb-6">
            <div class="flex items-start gap-6">
                ...
                <div class="shrink-0">
                    ...
                    @else
                        <div class="h-24 w-24 bg-indigo-100 rounded-full flex items-center justify-center border-4 border-indigo-50">
                ...
                <div class="flex-1">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div>
                            ...
                            <p class="text-lg font-semibold text-gray-900">{{ $student->name }} {{ $student->surname }}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-lg font-semibold text-gray-900">{{ $student->created_at->format('d.m.Y H:i') }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        @if($application)
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6 sm:p-8">
                <h2 class="text-xl sm:text-2xl font-bold text-gray-900 mb-6">Personal Information in Application</h2>
