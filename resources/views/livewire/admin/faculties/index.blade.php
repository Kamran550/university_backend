<div class="p-6 max-w-7xl mx-auto" x-data="{ showModal: false, showEditModal: false, showDeleteModal: false }" @close-modal.window="showModal = false" @close-edit-modal.window="showEditModal = false" @close-delete-modal.window="showDeleteModal = false" @faculty-created.window="showModal = false; $wire.$refresh()" @faculty-updated.window="showEditModal = false; $wire.$refresh()" @faculty-deleted.window="showDeleteModal = false; $wire.$refresh()">
    
    <!-- Header -->
    <div class="mb-8 flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Faculties</h1>
            <p class="mt-1 text-sm text-gray-600">All faculties and their degrees</p>
        </div>
        <button 
                        ...
                        <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <button 
                                        @click="showEditModal = true; $dispatch('edit-faculty', { facultyId: {{ $faculty->id }} })"
                                    ...
                                    <button 
                                        @click="showDeleteModal = true; $dispatch('delete-faculty', { facultyId: {{ $faculty->id }} })"
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center">
                                ...
                                <h3 class="mt-2 text-sm font-medium text-gray-900">Faculty not found</h3>
                                <p class="mt-1 text-sm text-gray-500">Add a new faculty to start.</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
        ...
        <div class="flex min-h-full items-center justify-center p-4">
            ...
            >
                ...
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">New Faculty</h2>
                        <p class="mt-1 text-sm text-gray-600">Add a new faculty</p>
                    </div>
                    <button 
                ...
                <div x-show="showModal">
                    <livewire:admin.faculties.create />
                </div>
            </div>
        </div>
    </div>
    ...
    >
        ...
        <div class="flex min-h-full items-center justify-center p-4">
            ...
            >
                ...
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">Edit Faculty</h2>
                        <p class="mt-1 text-sm text-gray-600">Update faculty information</p>
                    </div>
                    <button 
    ...
    >
        ...
        <div class="flex min-h-full items-center justify-center p-4">
            ...
            >
                <!-- Modal Header -->
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-2xl font-bold text-gray-900">Delete Faculty</h2>
                    <button 
                ...
                <div x-show="showDeleteModal">
                    <livewire:admin.faculties.delete />
                </div>
            </div>
        </div>
    </div>
