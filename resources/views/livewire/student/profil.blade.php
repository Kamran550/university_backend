                    ...
                    <div class="flex items-center gap-6">
                        ...
                        <div class="shrink-0">
                            @if($profile_photo_preview)
                                ...
                                >
                            @else
                                <div class="h-24 w-24 rounded-full bg-indigo-100 flex items-center justify-center border-4 border-gray-200" id="photo-placeholder">
                        ...
                        <div class="flex-1">
                            <label for="profile_photo" class="cursor-pointer">
                                ...
                                >
                                <div class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition">
                    ...
                    if (input.files && input.files[0]) {
                        ...
                        reader.onload = function(e) {
                            ...
                            if (preview) {
                                ...
                                placeholder.innerHTML = `<img src="${e.target.result}" alt="Preview" class="h-24 w-24 rounded-full object-cover border-4 border-gray-200" id="photo-preview">`;
                            }
                        };
